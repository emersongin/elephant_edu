...
if($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    //     'id_perfil' => 1
    // ]) == false) {
    //     echo falha('usuário ou token não autorizado!'); 
    //     exit;
    // }

    $nome = isset($_POST['nome']) ? parseTexto($_POST['nome']) : false;
    $responsavel = isset($_POST['responsavel']) ? parseTexto($_POST['responsavel']) : false;
...
if($_SERVER['REQUEST_METHOD'] == 'PUT') {
    ...
    $responsavel = isset($_PUT['responsavel']) ? parseTexto($_PUT['responsavel']) : false;
